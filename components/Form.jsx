...
function Form() {
  ...
  return (
    <form className="relative flex flex-col space-y-2 text-black/80 dark:text-white/75">
      ...
      <input
        type="text"
        placeholder="Añade una URL de foto (opcional)"
      ...
      <button
        className="absolute font-bold bottom-0 right-0  bg-blue-400 hover:bg-blue-500 disabled:text-black/40 disabled:bg-white/75 disabled:cursor-not-allowed text-white rounded-full px-3.5 py-1"
        type="submit"
        onClick={uploadPost}
